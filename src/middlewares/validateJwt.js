...
// en postman hay que enviarle el token, buscar cómo se hace
    ...
    // la cabecera HTTP “Authorization: Bearer <token>” se utiliza comúnmente en el protocolo HTTP para autenticar y autorizar solicitudes.
        ...
        // Bearer: es un tipo de esquema de autenticación que en esete caso, indica que se está proporcionando un token de acceso
